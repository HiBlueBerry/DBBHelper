...
{
    [CustomEntity("DBBHelper/FluidGlitchEffectControl")]
    public class FluidGlitchEffectControl : Entity
    {
        //------------------与控制特效相关------------------
        ...
        public FluidGlitchEffectControl(EntityData data, Vector2 offset)
        {
        ...
        private void UpdateParameter()
        {
            ...
            if (x_proportion >= 0.0f && x_proportion <= 1.0f && y_proportion >= 0.0f && y_proportion <= 1.0f)
            {
                ...
                List<Entity> FluidGlitchEffectEffectList;
                if (!DBBCustomEntityManager.TrackEntityOf_SubType(typeof(FluidGlitchEffect), out FluidGlitchEffectEffectList) || FluidGlitchEffectEffectList.Count == 0)
                {
                    return;
                }
                foreach (var entity_item in FluidGlitchEffectEffectList)
                {
                    var item = entity_item as FluidGlitchEffect;
