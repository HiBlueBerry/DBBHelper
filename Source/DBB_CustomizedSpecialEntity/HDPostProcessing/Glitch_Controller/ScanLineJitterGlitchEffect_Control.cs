...
{
    [CustomEntity("DBBHelper/ScanLineJitterGlitchEffectControl")]
    public class ScanLineJitterGlitchEffectControl : Entity
    {
        //------------------与控制特效相关------------------
        ...
        public ScanLineJitterGlitchEffectControl(EntityData data, Vector2 offset)
        {
        ...
        private void UpdateParameter()
        {
            ...
            if (x_proportion >= 0.0f && x_proportion <= 1.0f && y_proportion >= 0.0f && y_proportion <= 1.0f)
            {
                ...
                List<Entity> ScanLineJitterGlitchEffectList;
                if (!DBBCustomEntityManager.TrackEntityOf_SubType(typeof(ScanLineJitterGlitchEffect), out ScanLineJitterGlitchEffectList) || ScanLineJitterGlitchEffectList.Count == 0)
                {
                    return;
                }
                foreach (var entity_item in ScanLineJitterGlitchEffectList)
                {
                    var item = entity_item as ScanLineJitterGlitchEffect;
